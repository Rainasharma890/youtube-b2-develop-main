...
function VideoInfo(){
  ...
  Kalank Title Track - Lyrical | Alia Bhatt , Varun Dhawan | Arijit Singh | Pritam| Amitabh</h5>
  ...
  <div class="video-description">
    <p>434K views &nbsc; 1 year ago</p>
    <p>Here is the compilation video for all the random suggestions Shukla ji gave from the film Chhlaang. Watch this video for non-stop laughter and let us know in the comments which suggestion did you relate with the most.</p>
      ...
      <div className='suggested-video'>
        ...
        <div className='suggestion-content'>
          <div className='video-info'>
            ...
            <p class="margin-0 smaller-fontsize">{video.views}.{video.uploadedAt}</p>
          </div>
        </div>
      </div>
    </>
    ...
    <div>
      ...
      <div className='video-main-page'>
        ...
        <div className='suggestions'>
          ...
          {videos.map((video) => {
            return (<SuggestedVideos video={video} setVideo={setCurrVideoId}/>);
          })}
        </div>
      </div>
    </div>
